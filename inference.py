...
#Load Model in TensorRT
w = './best.trt'
print('Loading TensorRT engine from file: {}'.format(w))
device = torch.device('cuda:0')
#Image from camera feed (TODO: change to camera feed):

img = cv2.imread('/content/yolov7/inference/images/asl.jpg')
